...
module gamecomponent.scene {
	export class AvatarGuPai extends AvatarBase {
		private _value: number;
		get card() {
			return this._baseData as gamecomponent.object.PlayingGuPai;
		}
		constructor(g: Game, v: gamecomponent.object.PlayingGuPai) {
			super(g);
			this._baseData = v;
			this.texture_url = CompoentPath.custom_atlas_scene + 'gupai.atlas';
		}
